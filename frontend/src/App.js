...
function App() {
  ...
  const handleReqs = () => {
      navigate("/admin-requests");
        ...
        <Route path="/administration" element={<AddAdmin />} />
        ...
        <Route
          path="/home/creditPayment/:address"
        ...
        <Route
          ...
          element={<PharmacistRegisterPage />}
        />
        <Route path="/patient-register" element={<PatientRegisterForm />} />
        <Route path="/orderdetails" element={<OrderDetails />} />
        <Route
          path="/chatwithdoctor/:username"
          element={<ChatMessages socket={socket} />}
        />
        <Route
        // path="/chatwithpatient/:username"
        // element={<ChatMessagesDoctor socket={socket} />}
        />
