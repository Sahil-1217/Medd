...
export const Home = () => {
  ...
  const addAddress = async () => {
    try {
      ...
      const newAddress =
        `${addressName},${streetName},${buildingNumber},${floor},${apartment}`.replaceAll(
          " ",
          ""
        );
        ...
        <div className="home_page_content">
          <div className="BigContainer">
            <div className="Container1">
              ...
              <Box className="box1">
                ...
                <div className="line">
                  ...
                  >{`Mobile:  ${fullUser.MobileNumber}`}</div>
                </div>
                <div className="line">
                  <PhoneIcon
                    color="#005660"
                  ...
                  >{`Emergency Mobile:  ${fullUser.EmergencyContact_MobileNumber}`}</div>
                </div>
              </Box>
              ...
              {/* <Box className="box1">
                ...
                <div className="line" style={{ marginTop: "0px" }}>
                  ...
                  >
                    {fullUser.Notifications && fullUser.Notifications.length > 0
                ...
                <div className="line" style={{ marginTop: "-50px" }}>
                  ...
                  >
                    {fullUser.Notifications && fullUser.Notifications.length > 1
            ...
            <div className="Container2">
              ...
              {fullUser.Gender &&
                (fullUser.Gender.toLowerCase() === "male" ? (
              ...
              <Box className="Details" style={{ overflow: "hidden" }}>
                ...
                <Box className="GenderB">
                  {fullUser.Gender &&
                    (fullUser.Gender.toLowerCase() === "male" ? (
                      <Box className="Male">Male</Box>
                    ) : fullUser.Gender.toLowerCase() === "female" ? (
                      <Box className="Female">Female</Box>
                    ) : (
                      <Box className="Male">Male</Box>
                    ))}
                </Box>
                <Box
                  className="infoI"
                  style={{ transform: "translate(-30%, 395%)" }}
                >
                  Username
                </Box>
                ...
                {selectedTab === "two" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-28%, 750%)" }}
                    >
                      Date Of Birth
                    </Box>
                    <Box
                ...
                {selectedTab === "three" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-16%, 750%)" }}
                    >
                ...
                {selectedTab === "four" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-25%, 750%)" }}
                    >
                      Delivery Address
                    </Box>
                    <Box
                ...
                {selectedTab === "five" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-34%, 750%)" }}
                    >
                      Mobile
                    </Box>
                    <Box
                ...
                <RR
                  onRatingTabClick={handleRatingTabClick}
            ...
            <div className="Container3">
              <Link
                to="/medicine"
                className="box2s"
                style={{ color: "#005660", textDecoration: "none" }}
              >
                Shop
              </Link>
              <Link
