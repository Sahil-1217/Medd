...
export const Login = () => {
  ...
  return (
    ...
    <>
      <Grid
        templateColumns={{ base: "1fr", sm: "repeat(7, 1fr)" }}
        gap={6}
      ...
      >
          ...
          >
            ...
            <Box alignSelf="flex-start" mx={3} textAlign="start">
              <Text fontSize="2xl" as="cite">
                {" "}
                "Join our platform for access to top-tier doctors and
                hassle-free appointments. Your wellness journey starts here."{" "}
              </Text>
            </Box>
        ...
        <GridItem
          colSpan={{ base: "auto", sm: 3 }}
          h={"100%"}
          bg={"#005660"}
          borderLeftRadius={{ base: "none", sm: "xl" }}
        >
          <Flex
            w={"100%"}
            h={"100%"}
