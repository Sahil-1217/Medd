            ...
            <div className="Container1">
              ...
              <Box className="box1">
                ...
                <div className="line">
                  ...
                  >{`Affiliation:  ${fullUser.affiliation}`}</div>
                </div>
                <div className="line">
                  <PhoneIcon
                    color="#005660"
                  ...
                  >{`Educational Background:  ${fullUser.education_background}`}</div>
                </div>
              </Box>
              ...
              {/* <Box
                ...
                >
                  ...
                  fullUser.Notifications[0] !== undefined ? (
                  ...
                  {fullUser.Notifications &&
                  fullUser.Notifications[1] !== undefined ? (
              ...
              <Box className="Details" style={{ overflow: "hidden" }}>
                ...
                {selectedTab === "three" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-17%, 750%)" }}
                    >
                ...
                {selectedTab === "four" && (
                  <div>
                    <Box
                      className="infoI"
                      style={{ transform: "translate(-31%, 750%)" }}
                    >
                      Affiliation
                    </Box>
                    <Box
