...
function UserManagement() {
  ...
  return (
    <>
      <Navigation pagetitle={"Manage Users"} />
      <SidebarAdmin />
                    ...
                    users.map((user) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Td w={"20%"}>
                            {" "}
                            <Center> {firstLetterUpper(user.role)} </Center>
                          </Td>
                          <Td w={"20%"}>
                            {" "}
                          ...
                          <Td w={"20%"}>
                            <Center>
                              <Button
                                ...
                                size="sm"
                                onClick={(event) =>
                                  handleRemove(event, user._id, user.role)
                                }
                              >
                                Remove User
                              </Button>
            ...
            <DrawerContent>
              ...
              <DrawerHeader>
                <Text fontSize={"2xl"} textAlign={"center"}>
                  {firstLetterUpper(selectedUser.role)}
                </Text>
              ...
              <DrawerBody>
                <Flex justifyContent={"center"} alignItems={"center"}>
                  <Stack spacing={10}>
                    ...
                    <Text fontSize={"2xl"} color={"#00a6ff"}>
                      {" "}
                      <Center> {selectedUser.Email} </Center>{" "}
                    </Text>
                    <Box position="relative">
                      <Divider />
                      <AbsoluteCenter bg="white" px="4">
                    ...
                    {selectedUser.MobileNumber ? (
                      <>
                        ...
                        <Text fontSize={"2xl"} color={"#00a6ff"}>
                          {" "}
                          <Center> {selectedUser.MobileNumber} </Center>
                        </Text>
                      </>
                    ) : (
                      <></>
                        ...
                        <Box>
                          <Flex alignItems={"center"} justifyContent={"center"}>
                            <Text fontSize={"2xl"} color={"#00a6ff"}>
                              ...
                              <Center>
                                {" "}
                                {selectedUser.EmergencyContact_Relation}:{" "}
                              </Center>
                            </Text>
                            <Text fontSize={"2xl"} color={"#00a6ff"}>
                              {" "}
                          ...
                          <Text fontSize={"2xl"} color={"#00a6ff"}>
                            ...
                            <Center>
                              {" "}
                              {selectedUser.EmergencyContact_MobileNumber}{" "}
                            </Center>
                          </Text>
                        </Box>
                      </>
                    ...
                    {selectedUser.affiliation ? (
                      <>
                        ...
                        <Text fontSize={"2xl"} color={"#00a6ff"}>
                          {" "}
                          <Center> {selectedUser.affiliation} </Center>
                        </Text>
                      </>
                    ) : (
                      <></>
                    ...
                    {selectedUser.education_background ? (
                      <>
                        ...
                        <Text fontSize={"2xl"} color={"#00a6ff"}>
                          {" "}
                          <Center> {selectedUser.education_background} </Center>
                        </Text>
                      </>
                    ) : (
                      <></>
                    ...
                    {selectedUser.hourly_rate ? (
                      <>
                        ...
                        <Text fontSize={"2xl"} color={"#00a6ff"}>
                          {" "}
                          <Center> ${selectedUser.hourly_rate} </Center>
                        </Text>
                      </>
                    ) : (
                      <></>
