...
const Statistic=({currentMonth})=>{
    ...
    useEffect(() => {
        ...
        const fetchOrderStats = async () => {
          try {
            const response=await axios.post('https://medd-9.onrender.com/order/salesStats',{month:currentMonth},{ withCredentials: true });
        ...
        const fetchChanges = async () => {
            try {
                ...
                const responseCurrentMonth = await axios.post('https://medd-9.onrender.com/order/salesStats', { month: currentMonth }, { withCredentials: true });
                const responsePreviousMonth = await axios.post('https://medd-9.onrender.com/order/salesStats', { month: previousMonth }, { withCredentials: true });
