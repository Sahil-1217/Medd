...
function Analytic({currentMonth}) {
  ...
  useEffect(() => {
    fetch('https://medd-9.onrender.com/admin/MedNames')
      ...
      const fetchMedSales = async () => {
        ...
        try {
            const response = await axios.post('https://medd-9.onrender.com/order/sales', { month:currentMonth,med:selectedMedicine }, { withCredentials: true });
